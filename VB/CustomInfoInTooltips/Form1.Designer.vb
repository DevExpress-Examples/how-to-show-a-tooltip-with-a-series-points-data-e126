...
#End Region
        ...
        Private productsTableAdapter As CustomInfoInTooltips.nwindDataSetTableAdapters.ProductsTableAdapter

        Private nwindDataSet As CustomInfoInTooltips.nwindDataSet
