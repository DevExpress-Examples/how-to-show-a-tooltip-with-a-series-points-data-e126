	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal CategoryID As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal ReorderLevel As Short, ByVal Discontinued As Boolean, ByVal EAN13 As String) As ProductsRow
				...
				rowProductsRow.ItemArray = New Object() { Nothing, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13}
...
Namespace docShowSeriesPointTooltip.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As System.Nullable(Of Integer), ByVal Original_CategoryID As System.Nullable(Of Integer), ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice As System.Nullable(Of Decimal), ByVal Original_UnitsInStock As System.Nullable(Of Short), ByVal Original_UnitsOnOrder As System.Nullable(Of Short), ByVal Original_ReorderLevel As System.Nullable(Of Short), ByVal Original_Discontinued As Boolean, ByVal Original_EAN13 As String) As Integer
		...
		Public Overridable Function Insert(ByVal ProductName As String, ByVal SupplierID As System.Nullable(Of Integer), ByVal CategoryID As System.Nullable(Of Integer), ByVal QuantityPerUnit As String, ByVal UnitPrice As System.Nullable(Of Decimal), ByVal UnitsInStock As System.Nullable(Of Short), ByVal UnitsOnOrder As System.Nullable(Of Short), ByVal ReorderLevel As System.Nullable(Of Short), ByVal Discontinued As Boolean, ByVal EAN13 As String) As Integer
		...
		Public Overridable Function Update(ByVal ProductName As String, ByVal SupplierID As System.Nullable(Of Integer), ByVal CategoryID As System.Nullable(Of Integer), ByVal QuantityPerUnit As String, ByVal UnitPrice As System.Nullable(Of Decimal), ByVal UnitsInStock As System.Nullable(Of Short), ByVal UnitsOnOrder As System.Nullable(Of Short), ByVal ReorderLevel As System.Nullable(Of Short), ByVal Discontinued As Boolean, ByVal EAN13 As String, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As System.Nullable(Of Integer), ByVal Original_CategoryID As System.Nullable(Of Integer), ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice As System.Nullable(Of Decimal), ByVal Original_UnitsInStock As System.Nullable(Of Short), ByVal Original_UnitsOnOrder As System.Nullable(Of Short), ByVal Original_ReorderLevel As System.Nullable(Of Short), ByVal Original_Discontinued As Boolean, ByVal Original_EAN13 As String) As Integer
			If (ProductName Is Nothing) Then
				Throw New System.ArgumentNullException("ProductName")
			Else
